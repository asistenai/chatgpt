...
function onOpen() {
   DocumentApp.getUi().createMenu("Asisten Ai")
...
function myFunction() {
  var myKeyProperties = PropertiesService.getScriptProperties();
  myKeyProperties = myKeyProperties.getProperty('API_KEY')
  var api_key = myKeyProperties ;
 
  // console.log('MyKeyProperties:',api_key)

  generateText(api_key)
